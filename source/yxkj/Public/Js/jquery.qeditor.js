...
window.QEditor = {
  ...
  action: function(el, a, p) {
    ...
    if (a === "createLink") {
        ...
        success: function (res) {
          ...
          wx.uploadImage({
            ...
            success: function (res) {
              ...
              //上传的图片保存到本地服务器
              var url = window.location.protocol + '//' + window.location.host + '/Wx/Promotion/saveWXFile/img_dir/Promotion/media_id/'+serverId;
              $.post(url,function(res_data){
                if(typeof res_data != "object"){
                  var res_data = eval("("+res_data+")");
                }
                  if (res_data.data) {
                    QEditor.imageChange(res_data.data);
                  } else {
      ...
      //   fd.append('file', file);
      //   $.ajax({
      //     url : window.location.protocol + '//' + window.location.host + '/Wx/Promotion/upload_file/img_dir/Promotion',
      //     data : fd,
      //     processData : false,
      //     contentType : false,
