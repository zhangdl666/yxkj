                ...
                foreach ($left as $key => &$val) {
                    switch ($val['method']) {
                        case 'EquipmentInstall/index':
                            ...
                            $val['not_message_num'] = count($InstallData); 
                        ...
                        case 'EquipmentUpkeep/index':
                            ...
                            $val['not_message_num'] += count($MaintainData);
                        ...
                        case 'EquipmentMaintain/index':
                            ...
                            $val['not_message_num'] += count($RepairData);
                            if (!empty($RepairData)) {
                                $val['is_new'] = 1;
                            }
                            break;
                ...
                foreach ($left as $key => &$val) {
                    switch ($val['method']) {
                        ...
                        case 'EquipmentMaintain/index':
                            ...
                            $val['not_message_num'] += count($data);
                            if (!empty($data)) {
                                $val['is_new'] = 1;
                            }
                            break;
                    ...
                    switch ($val['method']) {
                        case 'ReturnMoney/index':
                            ...
                            $Returndata = M('ReturnMoney')
                                ...
                                ->order('o.mtime desc')
                                ->select();
                            $val['not_message_num'] += count($Returndata);
                            if (!empty($Returndata)) {
                                $val['is_new'] = 1;
                            }
                            break;
...
//                            $where['o.h_id'] = $_SESSION['USERINFO']['hotel_id'];
                        ...
                        case 'SaleGetmoney/index':
                            ...
                            $val['not_message_num'] += count($datass);
                        ...
                        case 'Reimbursement/index':
                            ...
                            $val['not_message_num'] += count($ReimbursementData);
...
//                return $left;
    ...
    {
        // 推送的url地址，使用自己的服务器地址
        $push_api_url = "http://123.56.185.102:2121/";
