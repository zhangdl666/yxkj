...
class HotelcHotelgHotelViewModel extends ViewModel{
    public $viewFields = array(
        ...
        'hotel' 	=> array('id'=>'h_id','provice','city','county','area','img'=>'h_img','is_get','is_sign','name'=>'h_name','ht_id','room_num','tell'=>'h_tell','shang_name','shang_tell','all_name','all_tell','money_name','money_tell','project_name','project_tell','_on'=>'hotel.id=hotelc.h_id','_type'=>'left'),
        'hotelg' 	=> array('_table'=>'yx_hotel_get','_on'=>'hotel.id=hotelg.h_id and hotelg.is_default=1','_type'=>'left'),
